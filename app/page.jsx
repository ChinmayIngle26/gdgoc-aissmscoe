...
export default async function HomePage() {
  ...
  return (
    <div className="scroll-smooth">
      ...
      <div className="z-20 clash-display fixed right-4 bottom-4 md:right-10 md:bottom-10 flex flex-col gap-3 items-end pointer-events-none *:pointer-events-auto">
        <LinkedinButton />
        <WhatsappButton />
        <DiscordButton />
      </div>
