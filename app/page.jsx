...
export default async function HomePage() {
  ...
  return (
    <div className="scroll-smooth">
      ...
      <Blogs blogs={blogs} />
      <Gallery />
      <div className="pointer-events-none *:pointer-events-auto z-20 clash-display fixed right-4 bottom-4 md:right-10 md:bottom-10 flex flex-col gap-3 justify-end">
        <DiscordButton />
        <WhatsappButton />
        <LinkedinButton />
      </div>
