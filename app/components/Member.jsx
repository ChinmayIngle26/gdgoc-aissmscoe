          ...
          <div className="flex gap-4 justify-center">
            {member.github && (
              <Link
                ...
                className="focus-visible:ring-2 focus-visible:ring-cream rounded focus-visible:outline-none"
              >
            ...
            {member.twitterinstagram && (
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label={member.twitterinstagram.includes("instagram") ? `${member.name} Instagram profile` : `${member.name} Twitter profile`}
                className="focus-visible:ring-2 focus-visible:ring-cream rounded focus-visible:outline-none"
              >
