...
export default function LinkedinButton() {
  return (
    <motion.a
      className="flex items-center text-[#0e7ac7] font-semibold bg-cream rounded-full px-2 py-1 overflow-hidden shadow-2xl absolute right-0 bottom-32 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-lightPurple focus-visible:ring-offset-2 focus-visible:ring-offset-purple"
      aria-label="Follow on LinkedIn"
      whileHover={{ width: "210px" }} // Expands to 200px on hover
      whileFocus={{ width: "210px" }} // Matches hover state for keyboard users
