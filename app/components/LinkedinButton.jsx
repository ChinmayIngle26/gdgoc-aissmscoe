...
export default function LinkedinButton() {
  return (
    <motion.a
      className="flex items-center focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-offset-2 text-[#0e7ac7] font-semibold bg-cream rounded-full px-2 py-1 overflow-hidden shadow-2xl absolute right-0 bottom-32"
