...
export default function LinkedinButton() {
  return (
    <motion.a
      className="focus-visible:ring-2 focus-visible:outline-none flex items-center text-[#0e7ac7] font-semibold bg-cream rounded-full px-2 py-1 overflow-hidden shadow-2xl absolute right-0 bottom-32"
      aria-label="Follow on LinkedIn"
      whileHover={{ width: "210px" }}
      whileFocus={{ width: "210px" }}
      target="_blank"
      rel="noopener noreferrer" // Expands to 200px on hover
