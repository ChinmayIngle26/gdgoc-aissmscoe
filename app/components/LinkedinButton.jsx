...
export default function LinkedinButton() {
  return (
    <motion.a
      className="flex items-center text-[#0e7ac7] font-semibold bg-cream rounded-full px-2 py-1 overflow-hidden shadow-2xl focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#0e7ac7] outline-none"
