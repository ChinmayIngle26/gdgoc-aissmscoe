...
export default function LinkedinButton() {
  return (
    <motion.a
      className="flex items-center text-[#0e7ac7] font-semibold bg-cream rounded-full px-2 py-1 overflow-hidden shadow-2xl focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-blue-500"
      aria-label="Follow on LinkedIn"
      whileHover={{ width: "210px" }} // Expands on hover
