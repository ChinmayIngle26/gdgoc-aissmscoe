...
export default function DiscordButton() {
  return (
    <motion.a
      className=" flex items-center text-[#5865F2] font-semibold bg-cream rounded-full px-2 py-1 overflow-hidden shadow-xl absolute right-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lightPurple"
