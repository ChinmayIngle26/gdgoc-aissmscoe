    ...
    >
      <div className="flex justify-between items-center h-20 resp-px">
        ...
        <motion.button
          whileTap={{ scale: 0.9 }}
          onClick={toggleMenu}
          aria-label={menuOpen ? "Close menu" : "Open menu"} aria-expanded={menuOpen} className="lg:hidden z-50 flex flex-col gap-1.5 p-2 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-current rounded"
        >
          <motion.span
            animate={{
