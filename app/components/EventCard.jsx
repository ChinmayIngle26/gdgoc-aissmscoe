...
export default function EventCard({ event }) {
  ...
  return (
    <div className="clash-display hover:scale-105 transition-transform text-xl bg-darkPurple shadow-md overflow-hidden border border-purple p-5">
      ...
      <div>
        {event.rsvpLink && (
          <a href={event.rsvpLink} target="_blank" rel="noopener noreferrer" className="font-semibold text-darkPurple bg-lightPink hover:bg-lightPurple hover:text-cream transition-colors px-4 py-2 btn-pink-slidein inline-block focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-lightPurple">
            RSVP Now
          </a>
        )}
      </div>
