      ...
      <div>
        {event.rsvpLink && (
          <a
            ...
            className="inline-block font-semibold text-darkPurple bg-lightPink hover:bg-lightPurple hover:text-cream transition-colors px-4 py-2 btn-pink-slidein focus-visible:ring-2 focus-visible:ring-lightPurple focus-visible:outline-none"
          >
            RSVP Now
          </a>
        )}
